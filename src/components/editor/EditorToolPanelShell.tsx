...
export function EditorToolPanelShell({
  ...
  return (
    <section className="flex max-h-[min(38dvh,15.5rem)] min-h-0 shrink-0 flex-col animate-slide-up border-t border-border/80 bg-surface shadow-[0_-4px_16px_rgb(44_62_80_/4%)]">
